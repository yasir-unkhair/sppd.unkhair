<div class="card">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-secondary" type="button"
                                                    wire:click="show_modal_daftar_surat" id="button-addon2">
                                                    Kode
                                                </button>
                                            </div>
                                        </div>
    ...
    @include('livewire.sppd.modal-daftar-surat')
    ...
    @push('script')
        ...
        <script>
            ...
            function pilih(kodesurat_id) {
                Livewire.dispatch('generate-nomor-spd', {
